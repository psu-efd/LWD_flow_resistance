...
Cd_all = np.array([36.5, 34.4, 58.3, 53.4, 16.5, 14.1, 20.5, 25.6, 60, 56.1, 51.5, 52.5, 64.8, 53.4, 45.4, 40])
...
# Plot all four cases
plt.scatter(Fr_full_without_sediment, Cd_full_without_sediment, label='Full-span, no sediment', marker='o', color='blue', s=200, facecolor='gray', edgecolor='blue')
plt.scatter(Fr_full_with_sediment, Cd_full_with_sediment, label='Full-span, with sediment', marker='o', color='blue', s=200, facecolor='gold', edgecolor='blue')
plt.scatter(Fr_half_without_sediment, Cd_half_without_sediment, label='Half-span, no sediment', marker='^', color='green', s=200, facecolor='gray', edgecolor='green')
plt.scatter(Fr_half_with_sediment, Cd_half_with_sediment, label='Half-span, with sediment', marker='^', color='green', s=200, facecolor='orange', edgecolor='green')

plt.xlabel('Froude Number ($Fr$)', fontsize=32)
plt.ylabel('Drag Coefficient ($C_d$)', fontsize=32)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cd_Fr_dependence_all_cases.png', dpi=300, bbox_inches='tight', pad_inches=0)
#plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cd_Fr_dependence_full_span_cases.png', dpi=300, bbox_inches='tight', pad_inches=0)
#plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cd_Fr_dependence_half_span_cases.png', dpi=300, bbox_inches='tight', pad_inches=0)
#plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cd_Fr_dependence_no_sediment_cases.png', dpi=300, bbox_inches='tight', pad_inches=0)
#plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cd_Fr_dependence_with_sediment_cases.png', dpi=300, bbox_inches='tight', pad_inches=0)
#plt.show()
plt.close()
