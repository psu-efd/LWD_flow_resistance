...
def plot_contour_from_vtk(case_ID, Fr, beta, Cd, alpha_exp, alpha_simulation, rect_x, rect_y, rect_width, rect_height, vtkFileName,
    ...
    if case_ID in [1, 2, 3, 4]:
        ax.set_title(rf"Case {case_ID}: $Fr$ = {Fr:.3f}, full-span, with sediment, $C_d$ = {Cd:.1f}", fontsize=52)
    else: 
        ax.set_title(rf"Case {case_ID}: $Fr$ = {Fr:.3f}, full-span, without sediment, $C_d$ = {Cd:.1f}", fontsize=52)
...
if __name__ == "__main__":
    ...
    Cds = [36.5, 34.4, 58.3, 53.4, 60, 56.1, 51.5, 52.5]
