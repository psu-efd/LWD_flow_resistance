...
def optimize_model_parameter(ManningN_or_Cd, parameter_bounds):
    ...
    # save simulation results to files: 'simulation_results_'+str(current_case_ID)+'.dat' and 'calibrated_ManningN_'+str(current_case_ID)+'.dat'/'calibrated_Cd_'+str(current_case_ID)+'.dat'
...
def objective_function_ManningN(ManningN, case_ID, ManningN_MaterialID, ManningN_MaterialName, bFullWidth):
    ...
    simulation_result = run_one_HEC_RAS_case_ManningN(case_ID, ManningN_MaterialID, ManningN[0], ManningN_MaterialName, faceless=False)
...
def save_calibration_results(ManningN_or_Cd, calibrated_value):
    ...
    if ManningN_or_Cd == "ManningN":
        ...
        with open('calibration_results/case_'+str(current_case_ID)+'/calibrated_ManningN.dat', 'w') as file:
        ...
        with open('calibration_results/case_'+str(current_case_ID)+'/calibrated_Cd.dat', 'w') as file:
            file.write(str(calibrated_value))
...
def run_case_with_optimized_ManningN(case_ID, faceless=True):
    """
    run the case with the optimized ManningN
    """

    #read the calibrated parameter (Manning's n or Cd)
    calibrated_ManningN_file = 'calibration_results/case_'+str(case_ID)+'/calibrated_ManningN.dat'
    ...
    ManningN_MaterialID = 1
    ManningN_MaterialName = 'LWD'
    simulation_result = run_one_HEC_RAS_case_ManningN(case_ID, ManningN_MaterialID, ManningN, ManningN_MaterialName, faceless=faceless)
