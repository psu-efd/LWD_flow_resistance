...
def optimize_model_parameter(parameter_bounds):
    ...
    # save simulation results to files: 'simulation_results_'+str(current_case_ID).zfill(2)+'.dat' and 'calibrated_b_Coefficient_'+str(current_case_ID).zfill(2)+'.dat'
...
def objective_function_b_Coefficient(b_Coefficient, case_ID, PorosityDrag_MaterialID, PorosityDrag_MaterialName, bFullWidth):
    ...
    simulation_result = run_one_HEC_RAS_case_PorosityDragCoefficient(case_ID, PorosityDrag_MaterialID, b_Coefficient[0], PorosityDrag_MaterialName, faceless=True)
...
def save_calibration_results(calibrated_value):
    ...
    with open('calibration_results/case_'+str(current_case_ID).zfill(2)+'/calibrated_b_Coefficient.dat', 'w') as file:
...
def run_case_with_optimized_b_Coefficient(case_ID):
    """
    run the case with the optimized b_coefficient
    """

    #read the calibrated parameter (b_coefficient)
    calibrated_b_Coefficient_file = 'calibration_results/case_'+str(case_ID).zfill(2)+'/calibrated_b_Coefficient.dat'
    ...
    PorosityDrag_MaterialID = 1
    PorosityDrag_MaterialName = 'LWD'
    simulation_result = run_one_HEC_RAS_case_PorosityDragCoefficient(case_ID, PorosityDrag_MaterialID, b_Coefficient, PorosityDrag_MaterialName, faceless=True)
