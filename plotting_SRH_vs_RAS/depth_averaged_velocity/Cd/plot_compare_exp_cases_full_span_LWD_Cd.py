...
def plot_contour_from_vtk(case_ID, Fr, beta, Cd_SRH_2D, Cd_HEC_RAS_2D, alpha_exp, alpha_simulation, rect_x, rect_y, rect_width, rect_height, vtkFileName_SRH_2D, vtkFileName_HEC_RAS_2D,
    ...
    if case_ID in [1, 2, 3, 4]:
        ax.set_title(rf"Case {case_ID}: $Fr$ = {Fr:.3f}, full-span, with sediment, $C_d$ = {Cd_SRH_2D:.1f} (SRH-2D), {Cd_HEC_RAS_2D:.1f} (HEC-RAS)", fontsize=52)
    else: 
        ax.set_title(rf"Case {case_ID}: $Fr$ = {Fr:.3f}, full-span, without sediment, $C_d$ = {Cd_SRH_2D:.1f} (SRH-2D), {Cd_HEC_RAS_2D:.1f} (HEC-RAS)", fontsize=52)
...
if __name__ == "__main__":
    ...
    Cds_SRH_2D = [36.4, 34.2, 58.6, 53.4, 58.9, 56, 51.2, 51.3]
    Cds_HEC_RAS_2D = [31.24, 31.68, 49.08, 48.36, 56, 52, 46.24, 47.28]
    ...
    for i, case_ID in enumerate(case_IDs):
        ...
        plot_contour_from_vtk(case_ID, Frs[i], betas[i], Cds_SRH_2D[i], Cds_HEC_RAS_2D[i], alphas_exp[i], alphas_simulation[i], rect_x, rect_y, rect_width, rect_height, vtkFileName_SRH_2D, vtkFileName_HEC_RAS_2D,
