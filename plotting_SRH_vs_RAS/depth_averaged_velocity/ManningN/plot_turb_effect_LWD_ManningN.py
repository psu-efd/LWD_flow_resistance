#Plot the effect of turbulence model on the result
...
def plot_contour_from_vtk(SRH_or_RAS, case_ID, Fr, beta, rect_x, rect_y, rect_width, rect_height, vtkFileName_w_turb, vtkFileName_wo_turb):
    ...
    # Save the plot
    output_filename = f'turb_effect_case_{case_ID}_ManningN_{SRH_or_RAS}.png'
...
if __name__ == "__main__":
    ...
    for i, case_ID in enumerate(case_IDs):
        ...
        #plot SRH-2D results
        vtkFileName_w_turb = "Exp_"+str(case_ID)+"_n/SRH2D_Exp_"+str(case_ID)+"_ManningN_C_0003.vtk"
        vtkFileName_wo_turb = "Exp_"+str(case_ID)+"_n/SRH2D_Exp_"+str(case_ID)+"_ManningN_C_0003_wo_turb.vtk"
        ...
        vtkFileName_w_turb = "Exp_"+str(case_ID)+"_n/RAS_2D_"+str(case_ID).zfill(2)+".vtk"
        vtkFileName_wo_turb = "Exp_"+str(case_ID)+"_n/RAS_2D_"+str(case_ID).zfill(2)+"_wo_turb.vtk"
